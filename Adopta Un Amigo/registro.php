...
$numeroId = $_POST["Numero Identificacion"];
$nombre = $_POST["nombre"] ;
...
if(!$connection) 
        ...
        $instruccion_SQL = "INSERT INTO users (numeroid,nombre,telefono, usuario, contraseña)
                             VALUES ('$numeroId','$nombre','$telefono','$usuario','$contraseña')";
